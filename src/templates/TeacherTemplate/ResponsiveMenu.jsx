...
const ResponsiveMenu = () => {
  ...
  return (
    <div className='bg-white w-full z-10 absolute top-0 right-0 p-2 translate-x-full hidden' id="btn_list">
        ...
        <ul
            className="space-y-3 mx-3 flex flex-col list-none items-center text-center"
