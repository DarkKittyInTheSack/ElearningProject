        ...
        <ul className="font-bold text-base w-2/3 mx-auto">
          ...
          <li>
            <p className="font-normal text-lg my-2">
              The learnit Affiliate API exposes functionalities of learnit to
              help developers build client applications and integrations with
              learnit. To see more details, please visit{" "}
              <span className="text-purple-500 underline underline-offset-1">
                learnit Affiliate API
              </span>
            </p>
          </li>

          <li>
            <button className=" bg-black py-3 px-4 text-lg text-white my-3">
