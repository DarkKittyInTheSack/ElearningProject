...
const CourseContent = ({coursesListData}) => {
                ...
                coursesListData ? (<li>
                    <button className='w-full border border-gray-400' onClick={() =>{
                        ...
                        <div className="flex items-center text-lg font-bold justify-between px-2 py-3 bg-gray-200 border-b border-gray-400">
                            <p className='text-center uppercase px-3'><i className='fa-solid fa-chevron-down text-xs pr-3 pl-2'></i>{coursesListData.tenDanhMucKhoaHoc}</p>
