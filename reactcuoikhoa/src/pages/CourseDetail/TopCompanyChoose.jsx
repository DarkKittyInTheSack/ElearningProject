...
const TopCompanyChoose = () => {
  return (
    <div className='border border-gray-400 w-4/6 p-3 my-8'>
        <h2 className='font-bold text-base mb-1 px-2'>Top companies offer this course to their employees</h2>
        <span className='font-normal text-sm mb-3 px-2'>This course was selected for our collection of top-rated courses trusted by businesses worldwide.
            <br /><Link className='underline text-purple-500 ml-2'> Learn more</Link>
        </span>
